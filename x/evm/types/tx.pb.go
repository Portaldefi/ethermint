...
// MetaEthereumTx encapsulates an Ethereum transaction with additional metadata.
type MsgMetaEthereumTx struct {
	// data is inner transaction data of the Ethereum transaction
	Data *types.Any `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	// size is the encoded storage size of the transaction (DEPRECATED)
	Size_ float64 `protobuf:"fixed64,2,opt,name=size,proto3" json:"-"`
	...
	// secp256k1 elliptic curve
	From string `protobuf:"bytes,4,opt,name=from,proto3" json:"from,omitempty"`
	// gas_price is the gas price used for the transaction
	GasPrice *github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,5,opt,name=gas_price,json=gasPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"gas_price,omitempty"`
	// gas_used is the amount of gas used by the transaction
	GasUsed uint64 `protobuf:"varint,6,opt,name=gas_used,json=gasUsed,proto3" json:"gas_used,omitempty"`
}

func (m *MsgMetaEthereumTx) Reset()         { *m = MsgMetaEthereumTx{} }
func (m *MsgMetaEthereumTx) String() string { return proto.CompactTextString(m) }
func (*MsgMetaEthereumTx) ProtoMessage()    {}
func (*MsgMetaEthereumTx) Descriptor() ([]byte, []int) {
	return fileDescriptor_f75ac0a12d075f21, []int{8}
}
func (m *MsgMetaEthereumTx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgMetaEthereumTx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgMetaEthereumTx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgMetaEthereumTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgMetaEthereumTx.Merge(m, src)
}
func (m *MsgMetaEthereumTx) XXX_Size() int {
	return m.Size()
}
func (m *MsgMetaEthereumTx) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgMetaEthereumTx.DiscardUnknown(m)
}

var xxx_messageInfo_MsgMetaEthereumTx proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgMetaEthereumTx)(nil), "ethermint.evm.v1.MsgMetaEthereumTx")
}
...
var fileDescriptor_f75ac0a12d075f21 = []byte{
	...
	,
}
...
func (m *MsgMetaEthereumTx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgMetaEthereumTx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgMetaEthereumTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgMetaEthereumTx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgMetaEthereumTx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgMetaEthereumTx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgMetaEthereumTx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
